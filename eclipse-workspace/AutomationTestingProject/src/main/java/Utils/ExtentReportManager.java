 ...
 * 
 * public class ExtentReportManager { public static ExtentReports report;
 * 
 * public static ExtentReports getReportInstance() {
 * 
 * if (report == null) { String reportName = DateUtils.getTimeStamp() + ".html";
 * ExtentHtmlReporter htmlReporter = new
 * ExtentHtmlReporter(System.getProperty("user.dir") + "/test-output/" +
 * reportName); report = new ExtentReports();
